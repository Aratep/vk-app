...
const style = {
  ...
  volume(currentVolume) {
    ...
    return {
      ...
      // left: '-45px',
      // bottom: '-15px',
      width:  "".concat(height * currentVolume, "px solid red"),
      height: '2px',
      //
      // zIndex: 19,
      // position: 'absolute',
        ...
        <div style={style.flexWrapper} className="flex">
          ...
          <div className="toggle-play-wrapper" style={style.togglePlayWrapper}>
            <a className="toggle-play-button" onClick={e => this.togglePlay(e)} style={style.togglePlay}>
              {isPlaying ? (
                <img src='../icons/pause.png' className="pause-icons" style={style.pause} />
              ) : (
                <img src='../icons/play.png' className="play-icons" style={style.play} />
              )}
            </a>
          </div>
          <div className="progress-bar-wrapper" style={style.progressBarWrapper}>
            ...
            <div className="audio-info" style={style.audioInfo}>
              ...
              <input id="vol-control"
                ...
                max="1"
                step="0.1"
                onChange={(e) => this.setState({currentVolume: e.target.value})}>
